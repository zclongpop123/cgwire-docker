...
RUN python3 -m venv /opt/zou/env && \
    ...
    /opt/zou/env/bin/pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade pip setuptools wheel && \
    /opt/zou/env/bin/pip install -i https://pypi.tuna.tsinghua.edu.cn/simple zou && \
